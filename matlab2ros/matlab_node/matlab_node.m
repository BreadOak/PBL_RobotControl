...
% subscirber
sub1 = ros2subscriber(testNode, "/mode_selection", "std_msgs/Int32", @callback_mode);
global mode;
mode = 1;
sub2 = ros2subscriber(testNode, "/ref_input", "std_msgs/Float64", @callback_input);
global input;
input = 0.0;
...
% Control_mode = mode;          % [1:Current, 2:Velocity, 3: Position]
Control_mode = 2;          
%--------------------------%
